...
class VQEmbedding(nn.Embedding):
    ...
    def _update_buffers(self, vectors, idxs):
        ...
        # vectors_sum_per_cluster = torch.clamp(vectors_sum_per_cluster, min=-1e3, max=1e3)
        # vectors_sum_per_cluster = torch.clamp(vectors_sum_per_cluster, min=-200, max=200)
        ...
        # self.embed_ema = torch.clamp(self.embed_ema, -200, 200)
