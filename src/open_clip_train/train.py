...
def train_one_epoch(model, original_state, data, loss, epoch, optimizer, scaler, scheduler, 
    ...
    logging.info(f"args.precision: {args.precision}")
    logging.info(f"autocast: {autocast}")
    ...
    logging.info(f"sem_weight: {sem_weight}")
    ...
    for i, batch in enumerate(dataloader):
        ...
        if args.stage == 0:
            # if hasattr(model, 'module'):
            #     for codebook in model.module.quantizer_pixel.codebooks:
            #         codebook.training = False
            # else:
            #     for codebook in model.quantizer_pixel.codebooks:
            #         codebook.training = False
            ...
            with autocast():
                ...
                with torch.no_grad():
                    ...
                    last_hidden_state_gt = outputs_gt.hidden_states[-1]
                ...
                # semantic_loss_total = 5 * (semantic_loss_last + semantic_loss_last_cos) + 5 * (semantic_loss_pooler + semantic_loss_pooler_cos)
                semantic_loss_total = 5 * (semantic_loss_pooler + semantic_loss_pooler_cos)
                losses = {
                    "semantic_loss": semantic_loss,
                    "semantic_loss_last": semantic_loss_last,
                    "semantic_loss_pooler": semantic_loss_pooler,
                    "semantic_loss_cos": semantic_loss_cos,
                    "semantic_loss_last_cos": semantic_loss_last_cos,
                    "semantic_loss_pooler_cos": semantic_loss_pooler_cos
                }
                
                losses["quant_loss_semantic"] = quant_loss_semantic
                losses["quant_loss_pixel"] = quant_loss_pixel
                ...
                total_loss = sem_weight * semantic_loss_total + 5 * (quant_loss_semantic + quant_loss_pixel) + 5 * rec_pixl_loss + p_weight * loss_pcpt
            ...
            with autocast():
                ...
                # semantic_loss_total = 5 * (semantic_loss + semantic_loss_cos) + (semantic_loss_last + semantic_loss_last_cos) + (semantic_loss_pooler + semantic_loss_pooler_cos)
                semantic_loss_total = 5 * (semantic_loss + semantic_loss_cos) + (semantic_loss_pooler + semantic_loss_pooler_cos)
                losses = {
                    "semantic_loss": semantic_loss,
                    "semantic_loss_last": semantic_loss_last,
                    "semantic_loss_pooler": semantic_loss_pooler,
                ...
                if use_discriminator:
                    ...
                    g_weight = calculate_adaptive_weight(
                        nll_loss=rec_pixl_loss + p_weight * loss_pcpt,
                        g_loss=loss_gen,
                ...
                total_loss = sem_weight * semantic_loss_total + 5 * (quant_loss_pixel + quant_loss_semantic) + 5 * rec_pixl_loss + p_weight * loss_pcpt + g_weight * d_weight * loss_gen
            ...
            with autocast():
                ...
                # semantic_loss_total = semantic_loss_cos + 5 * (semantic_loss_last + semantic_loss_last_cos) + 5 * (semantic_loss_pooler + semantic_loss_pooler_cos)
                semantic_loss_total = semantic_loss_cos + 5 * (semantic_loss_pooler + semantic_loss_pooler_cos)
                losses = {
                    "semantic_loss": semantic_loss,
                    "semantic_loss_last": semantic_loss_last,
                    "semantic_loss_pooler": semantic_loss_pooler,
                ...
                total_loss = sem_weight * semantic_loss_total + 5 * quant_loss_semantic
            ...
            raise NotImplementedError("args.stage should be 0, 1 or 2.")
