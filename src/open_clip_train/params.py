...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "pretrain_v6", "synthetic", "auto"],
        default="auto",
    ...
    parser.add_argument("--gan_start_epoch", type=int, default=1)
    parser.add_argument("--restart_gan", type=int, default=1)
    parser.add_argument(
        "--use-bn-sync",
        default=False,
        action="store_true",
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="path to load pretrained weight for stage2 finetuning.",
    )
    parser.add_argument(
        "--precision",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to the config file of the vision backbone to use.",
    )
    parser.add_argument(
        "--pretrained",
        default='',
