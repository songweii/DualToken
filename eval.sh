...
torchrun --nproc_per_node 1 -m eval \
    ...
    --weights_path "/inspire/hdd/project/deepgen/songwei-240108120100/DeepGen/opensource/DualToken-zloss/logs/siglip2-256-rvq44-16k-nolast-postquant-pixrq-semrqema-zloss/checkpoints/epoch_7.pt" \
